...
```bash
wget -Uri "http://www.cs.toronto.edu/~faghri/vsepp/vocab.tar" -OutFile "vocab.tar"
wget -Uri "http://www.cs.toronto.edu/~faghri/vsepp/data.tar" -OutFile "data.tar"
wget -Uri "http://www.cs.toronto.edu/~faghri/vsepp/runs.tar" -OutFile "runs.tar"
```
...
```bash
python train.py --data_path "./data" --data_name coco_precomp --logger_name  runs/coco_vse++ --max_violation
```
